...
const OurTeam = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* 🔹 CEO Section */}
      {ceo && (
        <div className="relative z-10 max-w-2xl px-5 py-12 mx-4 -mt-16 text-center bg-white shadow-md sm:mx-auto sm:py-16 rounded-xl">
          <img
            src={ceo.img}
            alt={ceo.name}
      ...
      {/* 🔹 Team Grid */}
      <div className="grid max-w-6xl gap-8 px-4 py-14 mx-auto sm:px-6 sm:py-16 md:grid-cols-2 lg:grid-cols-3">
      ...
      {/* 🔹 CTA Section */}
      <div className="px-4 py-14 text-center text-white bg-green-500 sm:py-16">
        <h2 className="mb-3 text-2xl font-bold sm:text-3xl">Want to Work With Us?</h2>
