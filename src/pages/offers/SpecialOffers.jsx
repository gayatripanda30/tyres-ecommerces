    ...
    >
      ...
      />
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center px-4">
          <div className="max-w-3xl p-10 text-center border shadow-lg w-[50%] bg-white/20 backdrop-blur-sm rounded-2xl border-white/10">
          ...
          >
            ...
            <div className="p-5">
              ...
              <button
                ...
                className="w-[50%] py-2  font-bold text-white transition bg-blue-900 rounded-full hover:bg-blue-800"
              >
                Shop Now
              </button>
            </div>
      ...
      {/* TERMS & CONDITIONS */}
      <div className="px-6 py-4 mx-auto mt-12 bg-yellow-50 w-[40%] rounded-xl">
