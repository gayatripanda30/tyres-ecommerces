...
import { carBatteries } from "../../data/carBatteries";
...
const CarBatteries = () => {
  ...
  // Filter Logic
  let filteredBatteries = carBatteries.filter(
    (battery) =>
  ...
  const brands = [...new Set(carBatteries.map((b) => b.brand))];
  const types = [...new Set(carBatteries.map((b) => b.type))];
