...
const Footer = () => {
  ...
  return (
    <footer className="text-white bg-black">
      ...
      >
        <div className="max-w-xl p-8 shadow-lg rounded-xl bg-black/70 backdrop-blur-md">
      ...
      <div className="grid grid-cols-1 gap-10 px-8 py-12 text-sm md:grid-cols-4">
        ...
        {/* Company */}
        <div>
          <h3 className="mb-4 font-semibold tracking-wide text-green-400">
            COMPANY
          </h3>
        ...
        <div>
          ...
          <p className="text-gray-400">Toll-Free: 800 555</p>
          <p className="text-gray-400">info@tyreshop.com</p>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <button className="px-4 py-1 text-black transition bg-white rounded hover:bg-gray-200">
              VISA
            </button>
            <button className="px-4 py-1 text-black transition bg-white rounded hover:bg-gray-200">
              MasterCard
